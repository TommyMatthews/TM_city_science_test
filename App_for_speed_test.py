#Variant of app for running Dijksta's algorithm with all print commands suppressed - for use in whole network speed test
...
#creating a duplicate array to lable unvisited verticies
...
#Initialising a dictionary of the previous vertex to the shortest path on each vertex
